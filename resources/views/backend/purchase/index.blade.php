...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="box">
            ...
            <h3 class="box-title">Purchase List   </h3><a href="{{route('purchase.add')}}" class="btn btn-primary pull-right">Add Purchase</a>
            </div>
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-hover table-responsive">
                ...
                <td>
                   @if($single_data->status == 1)
                   @elseif($single_data->status == 0)
                     <a href="{{route('purchase.delete',$single_data->id)}}" id="delete" title="Delete" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                   @endif
